 ...
 */
class ClientWebDAV : public QNetworkAccessManager
{
    Q_OBJECT
...
public:
    ...
    explicit ClientWebDAV(QObject *parent = nullptr);
    ~ClientWebDAV();
    ...
    QNetworkReply *proppatch(const QString &path, const ClientWebDAV::PropValues &props);
    ...
    QNetworkReply *lock(const QString &path,
                        ...
                        QWebdavLockScope scope = LOCK_SCOPE_EXCLUSIVE,
                        QWebdavLockDepth depth = LOCK_DEPTH_ZERO,
